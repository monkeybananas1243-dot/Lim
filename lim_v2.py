...
class NoteWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Lim Note - Untitled")
        ...
        self.set_font_size_box.setToolTip("Change the font size of the main text-box.")
    ...
    def save_file(self):
        ...
        if filename:
            ...
            self.setWindowTitle(f"Lim Note - {file_name_}")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.noteW = None
        self.create_note = QPushButton("Create Note")
        self.create_note.setFont(self.base_font)
        self.create_note.setToolTip("Create a new note")
        self.create_note.clicked.connect(self.create_new_note)
        button_layout.addWidget(self.create_note)
    ...
    def create_new_note(self):
        if self.noteW is None:
            self.noteW = NoteWindow()
        self.noteW.show()
